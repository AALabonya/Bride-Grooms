...
const Footer = () => {
    return (
        <footer className="px-4 divide-y dark:bg-gray-800 dark:text-gray-100 mt-5" style={{ backgroundImage: `url('https://i.ibb.co/931NCW1/footer.jpg')`, backgroundSize: 'cover' }}>
                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-3">
                        ...
                        <ul className="space-y-1">
                            <li><NavLink to="/" className="py-1 px-2"> Home</NavLink></li>
                            <li><NavLink to="/biodatas" className="py-1 px-2" >Biodatas</NavLink></li>

                            <li> <NavLink to="/aboutUs" className="py-1 px-2">About Us</NavLink></li>
                            <NavLink to="/contact" className="py-1 px-2">Contact</NavLink>

                            <li>
                            <NavLink to="/contact" className="py-1 px-2">Pricing</NavLink>
                            </li>
                            <li>
                            <NavLink to="/contact" className="py-1 px-2">Faq</NavLink>
                            </li>
