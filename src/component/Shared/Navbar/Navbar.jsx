...
import { Avatar, CardMedia, Container, ImageList, MenuItem, Stack } from '@mui/material';
                                        ...
                                        <div onClick={() => setIsOpen(!isOpen)}
                                            ...
                                            <div className="hidden md:block">
                                                ...
                                                <img
                                                    ...
                                                    src={user && user.photoURL ? user.photoURL : ""} alt="profile"
                                                    height="30"
                                                    width="30" />
                                        ...
                                        <div className="absolute rounded-xl shadow-md w-[40vw] md:w-[10vw] bg-white overflow-hidden right-0 top-12 text-sm">
                                            <div className="flex flex-col cursor-pointer">
                                                ...
                                                {user ? <>
                                                    ...
                                                    :
                                                    <><Link to="/login" className="px-4 py-3 text-black hover:bg-neutral-100 transition font-semibold">Login</Link>
                                                        <Link to="/signUp" className="px-4 py-3 text-black hover:bg-neutral-100 transition font-semibold">Sign Up</Link></>
                                                }
                                            </div>
                                        </div>
                                    )}
